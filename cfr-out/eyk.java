...
extends exx<ezu> {
        ...
        for (int $$19 = -$$14; $$19 < $$14; ++$$19) {
            for (int $$20 = -$$14; $$20 < $$14; ++$$20) {
                for (int $$21 = -1; $$21 > -$$12; --$$21) {
                    int $$22 = $$9 ? bgj.d((float)$$14 * (1.0f - (float)Math.pow($$21, 2.0) / ((float)$$12 * 8.0f))) : $$14;
    ...
    private void a(bgr $$0, dwp $$1, int $$2, int $$3, is $$4, boolean $$5, int $$6, double $$7, int $$8) {
        int $$9 = $$0.h() ? -1 : 1;
        int $$10 = $$0.h() ? -1 : 1;
    ...
    private void a(int $$0, int $$1, is $$2, dwp $$3, boolean $$4, double $$5, is $$6, int $$7, int $$8) {
        int $$9 = $$0 + 1 + $$7 / 3;
        ...
        for (int $$11 = -$$9; $$11 < $$9; ++$$11) {
            for (int $$12 = -$$9; $$12 < $$9; ++$$12) {
                ...
                if (!($$13 < 0.0) || !eyk.c($$15 = $$3.a_($$14 = $$2.b($$11, $$1, $$12))) && !$$15.a(dzs.er)) continue;
                if ($$4) {
                    this.a($$3, $$14, dzs.J.m());
                    continue;
                }
    ...
    private void a(dwp $$0, is $$1) {
        if ($$0.a_($$1.d()).a(dzs.ep)) {
            this.a($$0, $$1.d(), dzs.a.m());
        }
    }

    private void a(dwp $$0, bgr $$1, is $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, eoh $$13) {
        double $$14;
        double d2 = $$14 = $$9 ? this.a($$4, $$6, is.c, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, is.c, $$7, $$1);
        if ($$14 < 0.0) {
            double $$16;
            is $$15 = $$2.b($$4, $$5, $$6);
    ...
    private void a(is $$0, dwp $$1, bgr $$2, int $$3, int $$4, boolean $$5, boolean $$6, eoh $$7) {
        eoh $$8 = $$1.a_($$0);
        if ($$8.l() || $$8.a(dzs.er) || $$8.a(dzs.eq) || $$8.a(dzs.J)) {
            int $$10;
            boolean $$9 = !$$5 || $$2.j() > 0.05;
            int n2 = $$10 = $$5 ? 3 : 2;
            if ($$6 && !$$8.a(dzs.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
                this.a($$1, $$0, dzs.er.m());
            } else {
                this.a($$1, $$0, $$7);
            }
    ...
    private double a(int $$0, int $$1, is $$2, int $$3, bgr $$4) {
        float $$5 = 10.0f * bgj.a($$4.i(), 0.2f, 0.8f) / (float)$$3;
        return (double)$$5 + Math.pow($$0 - $$2.u(), 2.0) + Math.pow($$1 - $$2.w(), 2.0) - Math.pow($$3, 2.0);
    }

    private double a(int $$0, int $$1, is $$2, int $$3, int $$4, double $$5) {
    ...
    private int a(bgr $$0, int $$1, int $$2, int $$3) {
        float $$4 = 3.5f - $$0.i();
    ...
    private int b(bgr $$0, int $$1, int $$2, int $$3) {
    ...
    private static boolean c(eoh $$0) {
        return $$0.a(dzs.ju) || $$0.a(dzs.er) || $$0.a(dzs.nT);
    }
    ...
    private void a(dwp $$0, is $$1, int $$2, int $$3, boolean $$4, int $$5) {
        int $$6 = $$4 ? $$5 : $$2 / 2;
        for (int $$7 = -$$6; $$7 <= $$6; ++$$7) {
            for (int $$8 = -$$6; $$8 <= $$6; ++$$8) {
                for (int $$9 = 0; $$9 <= $$3; ++$$9) {
                    is $$10 = $$1.b($$7, $$9, $$8);
                    eoh $$11 = $$0.a_($$10);
                    if (!eyk.c($$11) && !$$11.a(dzs.ep)) continue;
                    if (this.a((dvt)$$0, $$10)) {
                        this.a($$0, $$10, dzs.a.m());
                        this.a($$0, $$10.d(), dzs.a.m());
                        continue;
                    }
                    if (!eyk.c($$11)) continue;
                    eoh[] $$12 = new eoh[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                    int $$13 = 0;
                    for (eoh $$14 : $$12) {
                        if (eyk.c($$14)) continue;
                        ++$$13;
                    }
                    if ($$13 < 3) continue;
                    this.a($$0, $$10, dzs.a.m());
