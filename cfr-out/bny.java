...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, $$2 -> {
            ...
            String $$7 = bny.a((String)((Pair)$$3.get()).getSecond(), $$6);
            if ($$7 != null) {
                $$4 = $$4.set($$1, (Object)Pair.of((Object)bqh.J.typeName(), (Object)$$7));
            }
    ...
    public static @Nullable String a(@Nullable String $$0, int $$1) {
        if (b.contains($$0)) {
            String $$2 = a.get($$0 + "." + $$1);
