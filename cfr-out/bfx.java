...
public class bfx {
     ...
     * Loose catch block
     */
    public static Path a(Path $$0, URL $$1, Map<String, String> $$2, HashFunction $$3, @Nullable HashCode $$4, int $$5, Proxy $$6, a $$7) {
        InputStream $$9;
        HttpURLConnection $$8;
        block21: {
            $$8 = null;
            ...
            if ($$4 != null) {
                ...
                try {
                    ...
                    a.warn("Failed to check cached file {}", (Object)$$10, (Object)$$11);
                }
                try {
                    a.warn("Existing file {} not found or had mismatched hash", (Object)$$10);
            ...
            HashCode $$16 = bfx.a($$3, $$5, $$7, $$9, $$13);
            if (!$$16.equals((Object)$$4)) {
                ...
                try {
                    try {
                        ...
                        if ($$8 != null && ($$21 = $$8.getErrorStream()) != null) {
                            try {
                                a.error("HTTP response error: {}", (Object)IOUtils.toString((InputStream)$$21, (Charset)StandardCharsets.UTF_8));
                            }
                            catch (Exception $$22) {
    ...
    private static void a(Path $$0) {
        try {
            ...
            a.warn("Failed to update modification time of {}", (Object)$$0, (Object)$$1);
        }
    }
    ...
    private static boolean a(Path $$0, HashFunction $$1, HashCode $$2) throws IOException {
        if (Files.exists($$0, new LinkOption[0])) {
            HashCode $$3 = bfx.a($$0, $$1);
            if ($$3.equals((Object)$$2)) {
                return true;
            }
    ...
    private static HashCode a(HashFunction $$0, int $$1, a $$2, InputStream $$3, Path $$4) throws IOException {
