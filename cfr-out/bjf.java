...
public class bjf
extends DataFix {
    public static final Map<String, String> a = (Map)DataFixUtils.make((Object)Maps.newHashMap(), $$0 -> {
    ...
    public TypeRewriteRule makeRule() {
        Type $$02 = this.getInputSchema().getType(bqh.x);
        Type $$1 = this.getOutputSchema().getType(bqh.x);
        TaggedChoice.TaggedChoiceType $$2 = this.getInputSchema().findChoiceType(bqh.w);
        TaggedChoice.TaggedChoiceType $$3 = this.getOutputSchema().findChoiceType(bqh.w);
