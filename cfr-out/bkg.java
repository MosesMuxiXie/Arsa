...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        Type $$32 = this.getOutputSchema().getType(bqh.d);
        ...
        return this.fixTypeEverywhereTyped("Chunk Renames; purge Level-tag", $$0, $$32, $$3 -> {
            ...
            Typed<?> $$5 = bkg.a($$4);
            $$5 = $$5.set(DSL.remainderFinder(), bkg.a($$3, (Dynamic)$$4.get(DSL.remainderFinder())));
            $$5 = bkg.a($$5, "TileEntities", "block_entities");
            $$5 = bkg.a($$5, "TileTicks", "block_ticks");
            $$5 = bkg.a($$5, "Entities", "entities");
            $$5 = bkg.a($$5, "Sections", "sections");
            $$5 = $$5.updateTyped($$2, $$4, $$0 -> bkg.a($$0, "Starts", "starts"));
            $$5 = bkg.a($$5, "Structures", "structures");
            return $$5.update(DSL.remainderFinder(), $$0 -> $$0.remove("Level"));
        });
    }

    private static Typed<?> a(Typed<?> $$0, String $$12, String $$2) {
        return bkg.a($$0, $$12, $$2, $$0.getType().findFieldType($$12)).update(DSL.remainderFinder(), $$1 -> $$1.remove($$12));
    }
