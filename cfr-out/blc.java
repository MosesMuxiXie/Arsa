...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Type $$4 = DSL.and((Type)DSL.optional((Type)DSL.field((String)"inTile", (Type)DSL.named((String)bqh.I.typeName(), (Type)DSL.or((Type)DSL.intType(), bsh.a())))), (Type)DSL.remainderType());
        Function<Typed, Typed> $$5 = $$1 -> $$1.update($$4.finder(), DSL.remainderType(), Pair::getSecond);
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", $$02.getType(bqh.H), $$12.getType(bqh.H), $$3 -> {
    ...
    private Typed<?> a(Typed<?> $$0) {
        Type $$1 = DSL.optional((Type)DSL.field((String)"Block", (Type)DSL.named((String)bqh.I.typeName(), (Type)DSL.or((Type)DSL.intType(), bsh.a()))));
        Type $$2 = DSL.optional((Type)DSL.field((String)"BlockState", (Type)DSL.named((String)bqh.y.typeName(), (Type)DSL.remainderType())));
        Dynamic $$3 = (Dynamic)$$0.get(DSL.remainderFinder());
        return $$0.update($$1.finder(), $$2, $$12 -> {
            int $$2 = (Integer)$$12.map($$02 -> (Integer)((Either)$$02.getSecond()).map($$0 -> $$0, blc::a), $$1 -> {
            ...
            return Either.left((Object)Pair.of((Object)bqh.y.typeName(), bjq.b($$2 << 4 | $$3)));
    ...
    private Typed<?> a(Typed<?> $$0, String $$1, String $$22, String $$3) {
        Tag.TagType $$4 = DSL.field((String)$$1, (Type)DSL.named((String)bqh.I.typeName(), (Type)DSL.or((Type)DSL.intType(), bsh.a())));
        Tag.TagType $$5 = DSL.field((String)$$3, (Type)DSL.named((String)bqh.y.typeName(), (Type)DSL.remainderType()));
        Dynamic $$6 = (Dynamic)$$0.getOrCreate(DSL.remainderFinder());
        return $$0.update($$4.finder(), (Type)$$5, $$2 -> {
            int $$3 = (Integer)((Either)$$2.getSecond()).map($$0 -> $$0, blc::a);
            int $$4 = $$6.get($$22).asInt(0) & 0xF;
            return Pair.of((Object)bqh.y.typeName(), bjq.b($$3 << 4 | $$4));
        }).set(DSL.remainderFinder(), (Object)$$6.remove($$22));
    }

    private Typed<?> a(Typed<?> $$0, String $$1, Function<Typed<?>, Typed<?>> $$2) {
        Type $$3 = this.getInputSchema().getChoiceType(bqh.H, $$1);
        Type $$4 = this.getOutputSchema().getChoiceType(bqh.H, $$1);
