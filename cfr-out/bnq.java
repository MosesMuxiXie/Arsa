...
public class bnq
extends DataFix {
    private static final @Nullable String[] a = (String[])DataFixUtils.make((Object)new String[256], $$0 -> {
        $$0[1] = "Item";
        $$0[2] = "XPOrb";
        $$0[7] = "ThrownEgg";
        $$0[8] = "LeashKnot";
    ...
    public bnq(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    public TypeRewriteRule makeRule() {
        Schema $$0 = this.getInputSchema();
        Type $$1 = $$0.getType(bqh.x);
        OpticFinder $$2 = DSL.fieldFinder((String)"id", (Type)DSL.named((String)bqh.J.typeName(), bsh.a()));
        ...
        OpticFinder $$6 = DSL.typeFinder((Type)$$0.getTypeRaw(bqh.H));
