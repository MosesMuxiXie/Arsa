...
extends Schema {
    ...
    protected static final Hook.HookFunction b = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> $$0, T $$1) {
            return bwr.a(new Dynamic($$0, $$1), a, bwr.a);
        }
    };

    public bwo(int $$0, Schema $$1) {
        super($$0, $$1);
    }

    public Type<?> getChoiceType(DSL.TypeReference $$0, String $$1) {
        if (Objects.equals($$0.typeName(), bqh.w.typeName())) {
            return super.getChoiceType($$0, bsh.a($$1));
        }
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
        ...
        bjf.a.forEach(($$1, $$2) -> $$12.put($$2, Objects.requireNonNull((Supplier)$$12.remove($$1), () -> "Didn't find " + $$1 + " in schema")));
        return $$12;
    }

    public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
        super.registerTypes($$0, $$1, $$2);
        $$0.registerType(true, bqh.w, () -> DSL.optionalFields((String)"components", (TypeTemplate)bqh.A.in($$0), (TypeTemplate)DSL.taggedChoiceLazy((String)"id", bsh.a(), (Map)$$2)));
