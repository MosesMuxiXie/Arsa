...
public class glj
implements gly {
    private static final amo a = amo.b("looking_at_fluid");
    ...
    public void a(glw $$02, @Nullable dwo $$1, @Nullable eqq $$2, @Nullable eqq $$3) {
        ...
        ftk $$6 = $$4.a(20.0, 0.0f, true);
        ArrayList<String> $$7 = new ArrayList<String>();
        if ($$6.d() == ftk.a.b) {
            is $$8 = ((fti)$$6).b();
            flb $$9 = $$5.b_($$8);
            $$7.add(String.valueOf(l.t) + "Targeted Fluid: " + $$8.u() + ", " + $$8.v() + ", " + $$8.w());
            $$7.add(String.valueOf(mi.c.b($$9.a())));
            for (Map.Entry<epk<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
                $$7.add(this.a($$10));
            }
            $$9.k().map($$0 -> "#" + String.valueOf($$0.b())).forEach($$7::add);
        }
        $$02.a(a, $$7);
    }
