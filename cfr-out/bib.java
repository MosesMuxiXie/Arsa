...
public class bib {
    public static Dynamic<?> a(Dynamic<?> $$0) {
        ...
        return bib.a($$0, ((Number)$$1.get()).intValue(), ((Number)$$2.get()).intValue(), ((Number)$$3.get()).intValue());
    }
    ...
    public static Dynamic<?> a(Dynamic<?> $$0, String $$1, String $$2, String $$3, String $$4) {
        ...
        return $$0.remove($$1).remove($$2).remove($$3).set($$4, bib.a($$0, ((Number)$$5.get()).intValue(), ((Number)$$6.get()).intValue(), ((Number)$$7.get()).intValue()));
    }
    ...
    public static Type<?> a(Type<?> $$0, Type<?> $$1, Type<?> $$2) {
        return $$0.all(bib.a($$1, $$2), true, false).view().newType();
    }
    ...
    public static Dynamic<?> a(String $$0, Map<String, String> $$12) {
        Dynamic $$2 = new Dynamic((DynamicOps)vn.a, (Object)new uz());
    ...
    public static Dynamic<?> a(String $$0) {
        return bib.a($$0, Map.of());
    }

    public static Dynamic<?> a(Dynamic<?> $$0, String $$1, UnaryOperator<String> $$22) {
    ...
    public static <T> Typed<?> a(Typed<?> $$0, OpticFinder<T> $$1, Dynamic<?> $$2) {
        return $$0.set($$1, bhs.a($$1.type(), $$2, true));
    }
}
