...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        Type $$22 = this.getOutputSchema().getType(bqh.S);
        ...
        return this.fixTypeEverywhereTyped(b, $$0, $$22, $$2 -> {
            ...
            return $$2.update(DSL.remainderFinder(), $$0 -> $$0.remove(a)).updateTyped($$1, $$3, $$3 -> bhs.a($$3, $$3, $$22 -> $$22.update("minecraft:overworld", $$2 -> $$2.update("generator", $$22 -> {
                ...
                if ("minecraft:flat".equals($$3)) {
                    ...
                    return $$22.update("settings", $$0 -> $$0.update("layers", bsa::a));
                }
                return $$22;
            }))));
        });
