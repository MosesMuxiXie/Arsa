...
extends de<a> {
    ...
    implements de.a {
        ...
        public static ak<a> a(dzq $$0) {
            bc $$1 = bc.a(frl.a($$0).build());
            return aj.z.a(new a(Optional.empty(), Optional.of($$1)));
        }

        public static ak<a> a(frm.a ... $$0) {
            bc $$1 = bc.a((frm[])Arrays.stream($$0).map(frm.a::build).toArray(frm[]::new));
            return aj.z.a(new a(Optional.empty(), Optional.of($$1)));
        }

        public static <T extends Comparable<T>> ak<a> a(dzq $$0, epk<T> $$1, String $$2) {
            dl.a $$3 = dl.a.a().a($$1, $$2);
            bc $$4 = bc.a(frl.a($$0).a($$3).build());
            return aj.z.a(new a(Optional.empty(), Optional.of($$4)));
        }

        public static ak<a> a(dzq $$0, epk<Boolean> $$1, boolean $$2) {
            return ch$a.a($$0, $$1, String.valueOf($$2));
        }

        public static ak<a> a(dzq $$0, epk<Integer> $$1, int $$2) {
            return ch$a.a($$0, $$1, String.valueOf($$2));
        }

        public static <T extends Comparable<T> & bhh> ak<a> a(dzq $$0, epk<T> $$1, T $$2) {
            return ch$a.a($$0, $$1, ((bhh)$$2).c());
        }

        private static a c(co.a $$0, cg.a $$1) {
            bc $$2 = bc.a(frk.a($$0).build(), frt.a($$1).build());
            return new a(Optional.empty(), Optional.of($$2));
        }

        public static ak<a> a(co.a $$0, cg.a $$1) {
            return aj.O.a(ch$a.c($$0, $$1));
        }

        public static ak<a> b(co.a $$0, cg.a $$1) {
            return aj.ac.a(ch$a.c($$0, $$1));
        }
