...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        Type $$0 = DSL.or((Type)DSL.intType(), (Type)DSL.named((String)bqh.J.typeName(), bsh.a()));
        Type $$1 = DSL.named((String)bqh.J.typeName(), bsh.a());
        OpticFinder $$22 = DSL.fieldFinder((String)"id", (Type)$$0);
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(bqh.x), this.getOutputSchema().getType(bqh.x), $$2 -> $$2.update($$22, $$1, $$02 -> (Pair)$$02.map($$0 -> Pair.of((Object)bqh.J.typeName(), (Object)bnl.a((int)$$0)), $$0 -> $$0)));
    }
}
