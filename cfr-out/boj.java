...
public class boj
extends DataFix {
    static final Map<String, String> a = bhs.a(Maps.newHashMap(), (? super T $$0) -> {
    ...
    public boj(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    protected TypeRewriteRule makeRule() {
        Type $$0 = this.getOutputSchema().getType(bqh.a);
        return this.fixTypeEverywhereTyped("LevelDataGeneratorOptionsFix", this.getInputSchema().getType(bqh.a), $$0, $$1 -> bhs.a($$1, $$0, $$0 -> {
            Object $$1 = $$0.get(b).asString().result();
            if ("flat".equalsIgnoreCase($$0.get("generatorName").asString(""))) {
                String $$2 = $$1.orElse("");
                return $$0.set(b, boj.a($$2, $$0.getOps()));
            }
            if ("buffet".equalsIgnoreCase($$0.get("generatorName").asString("")) && $$1.isPresent()) {
                JsonElement $$3 = bge.a((String)$$1.get());
                return $$0.set(b, new Dynamic((DynamicOps)JsonOps.INSTANCE, (Object)$$3).convert($$0.getOps()));
            }
            return $$0;
        }));
    }
    ...
    private static <T> Dynamic<T> a(String $$0, DynamicOps<T> $$13) {
        ...
        if (!$$0.isEmpty() && $$2.hasNext()) {
            List<Pair<Integer, String>> $$5 = boj.b((String)$$2.next());
            if (!$$5.isEmpty()) {
                if ($$2.hasNext()) {
    ...
    private static @Nullable Pair<Integer, String> a(String $$0) {
        int $$4;
        String[] $$1 = $$0.split("\\*", 2);
        if ($$1.length == 2) {
            try {
