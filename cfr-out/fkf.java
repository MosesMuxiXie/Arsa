...
public class fkf {
    ...
    @Deprecated
    public static fkf a(bgr $$0, IntStream $$1) {
        return new fkf($$0, fkf.a((IntSortedSet)new IntRBTreeSet((Collection)$$1.boxed().collect(ImmutableList.toImmutableList()))), false);
    }

    @Deprecated
    public static fkf a(bgr $$0, int $$1, DoubleList $$2) {
        return new fkf($$0, (Pair<Integer, DoubleList>)Pair.of((Object)$$1, (Object)$$2), false);
    }

    public static fkf b(bgr $$0, IntStream $$1) {
        return fkf.a($$0, (List)$$1.boxed().collect(ImmutableList.toImmutableList()));
    }

    public static fkf a(bgr $$0, List<Integer> $$1) {
        return new fkf($$0, fkf.a((IntSortedSet)new IntRBTreeSet($$1)), true);
    }

    public static fkf a(bgr $$0, int $$1, double $$2, double ... $$3) {
        DoubleArrayList $$4 = new DoubleArrayList($$3);
        $$4.add(0, $$2);
        return new fkf($$0, (Pair<Integer, DoubleList>)Pair.of((Object)$$1, (Object)$$4), true);
    }

    public static fkf b(bgr $$0, int $$1, DoubleList $$2) {
        return new fkf($$0, (Pair<Integer, DoubleList>)Pair.of((Object)$$1, (Object)$$2), true);
    }
    ...
    protected fkf(bgr $$02, Pair<Integer, DoubleList> $$1, boolean $$2) {
        ...
        if ($$2) {
            ...
            for (int $$6 = 0; $$6 < $$3; ++$$6) {
                ...
                int $$7 = this.c + $$6;
                this.b[$$6] = new fkc($$5.a("octave_" + $$7));
            }
        } else {
            double $$9;
            fkc $$8 = new fkc($$02);
    ...
    public double a(double $$0, double $$1, double $$2, double $$3, double $$4, boolean $$5) {
        ...
        for (int $$9 = 0; $$9 < this.b.length; ++$$9) {
            fkc $$10 = this.b[$$9];
            if ($$10 != null) {
                double $$11 = $$10.a(fkf.b($$0 * $$7), $$5 ? -$$10.b : fkf.b($$1 * $$7), fkf.b($$2 * $$7), $$3 * $$7, $$4 * $$7);
    ...
    public @Nullable fkc a(int $$0) {
        return this.b[this.b.length - 1 - $$0];
    }

    public static double b(double $$0) {
        return $$0 - (double)bgj.d($$0 / 3.3554432E7 + 0.5) * 3.3554432E7;
    }
