...
extends Record {
    ...
    public String a() {
        try {
            return this.g.get((int)(bhs.d() % (long)this.g.size()));
        }
        catch (Throwable $$0) {
    ...
    public final String toString() {
        return ObjectMethods.bootstrap("toString", new MethodHandle[]{u.class, "header;nuggets", "f", "g"}, this);
    }

    @Override
    public final int hashCode() {
        return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{u.class, "header;nuggets", "f", "g"}, this);
    }

    @Override
    public final boolean equals(Object $$0) {
        return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{u.class, "header;nuggets", "f", "g"}, this, $$0);
    }
