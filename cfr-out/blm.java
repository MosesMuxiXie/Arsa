...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("EntityHealthFix", this.getInputSchema().getType(bqh.H), $$0 -> $$0.update(DSL.remainderFinder(), this::a));
    }
}
