...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        Type $$0 = this.getOutputSchema().getType(bqh.L);
        return this.fixTypeEverywhereTyped("MobSpawnerEntityIdentifiersFix", this.getInputSchema().getType(bqh.L), $$0, $$1 -> {
