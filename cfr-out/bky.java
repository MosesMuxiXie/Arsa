...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("EmptyItemInHotbarFix", this.getInputSchema().getType(bqh.e), $$1 -> $$1.update($$0, $$02 -> $$02.mapSecond($$0 -> {
            boolean $$4;
            ...
            boolean bl2 = $$4 = $$2.get("Count").asInt(0) <= 0;
            if ($$3 || $$4) {
