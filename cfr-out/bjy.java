...
extends DataFix {
    ...
    private <TE> TypeRewriteRule a(Type<?> $$0, List.ListType<TE> $$1) {
        ...
        int $$5 = 416;
        return TypeRewriteRule.seq((TypeRewriteRule)this.fixTypeEverywhere("InjectBedBlockEntityType", (Type)this.getInputSchema().findChoiceType(bqh.w), (Type)this.getOutputSchema().findChoiceType(bqh.w), $$02 -> $$0 -> $$0), (TypeRewriteRule)this.fixTypeEverywhereTyped("BedBlockEntityInjecter", this.getOutputSchema().getType(bqh.d), $$32 -> {
            ...
            for (Dynamic $$10 : $$9) {
                ...
                Streams.mapWithIndex((IntStream)$$10.get("Blocks").asIntStream(), ($$4, $$5) -> {
                    if (416 == ($$4 & 0xFF) << 4) {
                        int $$6 = (int)$$5;
                        int $$7 = $$6 & 0xF;
                        int $$8 = $$6 >> 8 & 0xF;
