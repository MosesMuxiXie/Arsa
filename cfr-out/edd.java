...
public class edd
extends dyl {
    public static final MapCodec<edd> c = edd.b(edd::new);

    public MapCodec<edd> a() {
        return c;
    }

    protected edd(eog.d $$0) {
        super($$0);
    }
    ...
    public void a(eoh $$0, dwo $$1, is $$2, bgr $$3) {
        ...
        if ($$3.j() < 0.1) {
            $$1.a($$4, $$5, $$6, bda.lM, bdb.e, 1.0f, 1.0f, false);
        }
        iz $$7 = (iz)$$0.c(a);
        iz.a $$8 = $$7.o();
        double $$9 = 0.52;
        ...
        $$1.a(ly.G, $$4 + $$11, $$5 + $$12, $$6 + $$13, 0.0, 0.0, 0.0);
    }
}
