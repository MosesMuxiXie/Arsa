...
extends DataFix {
    ...
    public bih(Schema $$0, DSL.TypeReference $$1) {
        super($$0, false);
        this.a = $$1;
    }
    ...
    protected static Optional<Dynamic<?>> a(Dynamic<?> $$0, String $$1, String $$2) {
        return bih.a($$0, $$1).map($$3 -> $$0.remove($$1).set($$2, $$3));
    }

    protected static Optional<Dynamic<?>> b(Dynamic<?> $$0, String $$1, String $$2) {
        return $$0.get($$1).result().flatMap(bih::a).map($$3 -> $$0.remove($$1).set($$2, $$3));
    }

    protected static Optional<Dynamic<?>> c(Dynamic<?> $$0, String $$1, String $$2) {
        String $$3 = $$1 + "Most";
        String $$42 = $$1 + "Least";
        return bih.d($$0, $$3, $$42).map($$4 -> $$0.remove($$3).remove($$42).set($$2, $$4));
    }
        ...
        return $$0.get($$12).result().flatMap($$1 -> {
            ...
            if ($$2 != null) {
                try {
                    ...
                    return bih.a($$0, $$3.getMostSignificantBits(), $$3.getLeastSignificantBits());
                }
