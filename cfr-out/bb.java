...
extends de<a> {
    ...
    implements de.a {
        ...
        public static final Codec<a> a = RecordCodecBuilder.create($$0 -> $$0.group((App)bs.b.optionalFieldOf("player").forGetter(a::a), (App)cg.a.optionalFieldOf("item").forGetter(a::c)).apply((Applicative)$$0, a::new));
        ...
        public static ak<a> b() {
            return aj.A.a(new a(Optional.empty(), Optional.empty()));
        }

        public static ak<a> a(je<dlp> $$0, dwn $$1) {
            return bb$a.a(cg.a.a().a($$0, $$1.h()));
        }

        public static ak<a> a(cg.a $$0) {
            return aj.A.a(new a(Optional.empty(), Optional.of($$0.b())));
        }
