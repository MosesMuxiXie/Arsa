...
public class bpl
extends DataFix {
    public bpl(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyTranslationFix", this.getInputSchema().getType(bqh.f), $$02 -> $$02.update(DSL.remainderFinder(), $$0 -> $$0.getMapValues().map($$12 -> $$0.createMap($$12.entrySet().stream().map($$1 -> {
            String $$2;
