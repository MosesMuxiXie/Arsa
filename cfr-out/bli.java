...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.a(this.getInputSchema().getTypeRaw(bqh.x), this.getOutputSchema().getTypeRaw(bqh.x));
    }

    private <ItemStackOld, ItemStackNew> TypeRewriteRule a(Type<ItemStackOld> $$02, Type<ItemStackNew> $$12) {
        Type $$2 = DSL.named((String)bqh.E.typeName(), (Type)DSL.optional((Type)DSL.field((String)"Equipment", (Type)DSL.list($$02))));
        Type $$3 = DSL.named((String)bqh.E.typeName(), (Type)DSL.and((Type)DSL.optional((Type)DSL.field((String)"ArmorItems", (Type)DSL.list($$12))), (Type)DSL.optional((Type)DSL.field((String)"HandItems", (Type)DSL.list($$12))), (Type)DSL.optional((Type)DSL.field((String)"body_armor_item", $$12)), (Type)DSL.optional((Type)DSL.field((String)"saddle", $$12))));
        if (!$$2.equals((Object)this.getInputSchema().getType(bqh.E))) {
            throw new IllegalStateException("Input entity_equipment type does not match expected");
        }
        if (!$$3.equals((Object)this.getOutputSchema().getType(bqh.E))) {
            throw new IllegalStateException("Output entity_equipment type does not match expected");
        }
        return TypeRewriteRule.seq((TypeRewriteRule)this.fixTypeEverywhereTyped("EntityEquipmentToArmorAndHandFix - drop chances", this.getInputSchema().getType(bqh.H), $$0 -> $$0.update(DSL.remainderFinder(), bli::a)), (TypeRewriteRule)this.fixTypeEverywhere("EntityEquipmentToArmorAndHandFix - equipment", $$2, $$3, $$1 -> {
