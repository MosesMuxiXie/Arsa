...
public class boz
extends DataFix {
    public boz(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    protected TypeRewriteRule makeRule() {
        CompoundList.CompoundListType $$0 = DSL.compoundList((Type)DSL.string(), (Type)this.getInputSchema().getType(bqh.M));
    ...
    private <SF> TypeRewriteRule a(CompoundList.CompoundListType<String, SF> $$02) {
        ...
        Type $$2 = this.getInputSchema().getType(bqh.M);
        ...
        }))))), (TypeRewriteRule)this.fixTypeEverywhereTyped("NewVillageStartFix", $$2, $$0 -> $$0.update(DSL.remainderFinder(), $$02 -> $$02.update("id", $$0 -> Objects.equals(bsh.a($$0.asString("")), "minecraft:new_village") ? $$0.createString("minecraft:village") : $$0))));
    }
}
