...
extends DataFix {
    ...
    private static final @Nullable String[] c = (String[])DataFixUtils.make((Object)new String[128], $$0 -> {
        $$0[0] = a;
            ...
            if ($$3.isPresent() && Objects.equals(((Pair)$$3.get()).getSecond(), "minecraft:potion")) {
                ...
                if ($$5.isPresent()) {
                    ...
                    if ($$9.isEmpty()) {
                        ...
                        $$7 = $$7.set($$22, $$11);
                        if (($$6 & 0x4000) == 16384) {
                            $$7 = $$7.set($$1, (Object)Pair.of((Object)bqh.J.typeName(), (Object)"minecraft:splash_potion"));
                        }
                    }
                    if ($$6 != 0) {
