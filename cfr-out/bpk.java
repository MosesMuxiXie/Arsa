...
extends DataFix {
    ...
    public bpk(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(bqh.f), $$02 -> $$02.update(DSL.remainderFinder(), $$0 -> $$0.getMapValues().map($$1 -> $$0.createMap($$1.entrySet().stream().map($$0 -> {
