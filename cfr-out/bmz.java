...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.a(this.getOutputSchema().getTypeRaw(bqh.P));
    }
    ...
    private <R> TypeRewriteRule a(Type<R> $$0) {
        ...
        OpticFinder $$2 = DSL.namedChoice((String)"minecraft:furnace", (Type)this.getInputSchema().getChoiceType(bqh.w, "minecraft:furnace"));
        OpticFinder $$3 = DSL.namedChoice((String)"minecraft:blast_furnace", (Type)this.getInputSchema().getChoiceType(bqh.w, "minecraft:blast_furnace"));
        OpticFinder $$4 = DSL.namedChoice((String)"minecraft:smoker", (Type)this.getInputSchema().getChoiceType(bqh.w, "minecraft:smoker"));
        Type $$5 = this.getOutputSchema().getChoiceType(bqh.w, "minecraft:furnace");
        Type $$6 = this.getOutputSchema().getChoiceType(bqh.w, "minecraft:blast_furnace");
        Type $$7 = this.getOutputSchema().getChoiceType(bqh.w, "minecraft:smoker");
        Type $$82 = this.getInputSchema().getType(bqh.w);
        Type $$9 = this.getOutputSchema().getType(bqh.w);
