...
extends DataFix {
    ...
    public final TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemStack bucket_entity_data variants to separate components", $$0, $$2 -> {
            ...
            return switch ($$3 = $$2.getOptional($$1).map(Pair::getSecond).orElse("")) {
                case "minecraft:salmon_bucket" -> $$2.updateTyped($$22, bme::c);
                case "minecraft:axolotl_bucket" -> $$2.updateTyped($$22, bme::b);
                case "minecraft:tropical_fish_bucket" -> $$2.updateTyped($$22, bme::a);
                case "minecraft:painting" -> $$2.updateTyped($$22, $$0 -> bhs.a($$0, $$0.getType(), bme::a));
                default -> $$2;
            };
        });
    }
    ...
    private static String a(int $$0) {
        return bib.a($$0 >> 16 & 0xFF);
    }

    private static String b(int $$0) {
        return bib.a($$0 >> 24 & 0xFF);
    }
    ...
    private static <T> Dynamic<T> a(Dynamic<T> $$02, Dynamic<T> $$1) {
    ...
    private static <T> Dynamic<T> b(Dynamic<T> $$02, Dynamic<T> $$1) {
    ...
    private static <T> Dynamic<T> c(Dynamic<T> $$02, Dynamic<T> $$1) {
