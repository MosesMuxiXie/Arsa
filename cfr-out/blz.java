...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Type $$2 = $$0.getTypeRaw(bqh.G);
        Type $$3 = $$1.getTypeRaw(bqh.G);
        Type $$4 = $$0.getTypeRaw(bqh.H);
    ...
    private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule a(Schema $$0, Schema $$1, Type<OldEntityTree> $$2, Type<NewEntityTree> $$3, Type<Entity> $$4) {
        Type $$52 = DSL.named((String)bqh.G.typeName(), (Type)DSL.and((Type)DSL.optional((Type)DSL.field((String)"Riding", $$2)), $$4));
        Type $$6 = DSL.named((String)bqh.G.typeName(), (Type)DSL.and((Type)DSL.optional((Type)DSL.field((String)"Passengers", (Type)DSL.list($$3))), $$4));
        Type $$7 = $$0.getType(bqh.G);
        Type $$8 = $$1.getType(bqh.G);
        ...
        Type $$12 = $$0.getType(bqh.c);
        Type $$13 = $$1.getType(bqh.c);
        return TypeRewriteRule.seq((TypeRewriteRule)this.fixTypeEverywhere("EntityRidingToPassengerFix", $$52, $$6, $$5 -> $$6 -> {
            ...
            while (true) {
                ...
                $$7 = Optional.of(Pair.of((Object)bqh.G.typeName(), (Object)Pair.of((Object)$$9, (Object)((Pair)$$8.getSecond()).getSecond())));
