...
extends DataFix {
    ...
    public blp(Schema $$0, boolean $$1) {
        super($$0, $$1);
    }

    public TypeRewriteRule makeRule() {
        TaggedChoice.TaggedChoiceType $$02 = this.getInputSchema().findChoiceType(bqh.H);
        TaggedChoice.TaggedChoiceType $$1 = this.getOutputSchema().findChoiceType(bqh.H);
        Type $$2 = this.getInputSchema().getType(bqh.x);
        Type $$3 = this.getOutputSchema().getType(bqh.x);
