...
implements ArgumentType<ge> {
    ...
    public static gi a(boolean $$0) {
        return new gi($$0);
    }

    public static ftl a(CommandContext<ed> $$0, String $$1) {
        ftm $$2 = ((ge)$$0.getArgument($$1, ge.class)).a((ed)$$0.getSource());
        return new ftl((float)$$2.g, (float)$$2.i);
    }
