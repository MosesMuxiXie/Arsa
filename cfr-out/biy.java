...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        Type $$6 = DSL.named((String)bqh.y.typeName(), (Type)DSL.remainderType());
        OpticFinder $$7 = DSL.fieldFinder((String)"Palette", (Type)DSL.list((Type)$$6));
        return this.fixTypeEverywhereTyped("BitStorageAlignFix", $$0, this.getOutputSchema().getType(bqh.d), $$4 -> $$4.updateTyped($$2, $$3 -> this.a(biy.a($$3, $$5, $$7, $$3))));
    }

    private Typed<?> a(Typed<?> $$02) {
        return $$02.update(DSL.remainderFinder(), $$0 -> $$0.update("Heightmaps", $$1 -> $$1.updateMapValues($$12 -> $$12.mapSecond($$1 -> biy.a($$0, $$1, 256, 9)))));
    }
    ...
    private static Typed<?> a(OpticFinder<?> $$0, OpticFinder<?> $$1, OpticFinder<List<Pair<String, Dynamic<?>>>> $$22, Typed<?> $$3) {
        return $$3.updateTyped($$0, $$2 -> $$2.updateTyped($$1, $$12 -> {
            ...
            return $$12.update(DSL.remainderFinder(), $$1 -> $$1.update("BlockStates", $$2 -> biy.a($$1, $$2, 4096, $$2)));
        }));
    }
