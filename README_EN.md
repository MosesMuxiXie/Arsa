...
Arsa is a Fabric mod for Minecraft 1.21.11. It turns enchanted books into
...
`arsa-1.1.0-mc1.21.11.jar` and `arsa-1.1.0-mc1.21.11-sources.jar`. Install only the former in the
