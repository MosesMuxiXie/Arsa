...
Arsa is a Fabric mod for Minecraft 1.18.2. It turns enchanted books into
...
`arsa-1.1.0-mc1.18.2.jar` and `arsa-1.1.0-mc1.18.2-sources.jar`. Install only the former in the
game's `mods` directory.

Building requires Java 17. Running the mod requires Fabric Loader 0.19.3 and
Fabric API 0.77.0+1.18.2. See `arsa-design.md` for the detailed design and
