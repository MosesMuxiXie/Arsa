...
Arsa is a Fabric mod for Minecraft 1.18. It turns enchanted books into
...
`arsa-1.1.0-mc1.18.jar` and `arsa-1.1.0-mc1.18-sources.jar`. Install only the former in the
